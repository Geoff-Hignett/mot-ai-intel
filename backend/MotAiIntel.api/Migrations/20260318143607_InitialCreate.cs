...
namespace MotAiIntel.api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearlyMileage = table.Column<int>(type: "int", nullable: true),
                    DrivingType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MechanicalKnowledge = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
